...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            using (StreamReader reader = new StreamReader("C:\\21\\brou.txt"))
            {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            using (StreamWriter sw = new StreamWriter("C:\\21\\brou.txt"))
            {
                sw.WriteLine(listBox1.Items.Count.ToString()); for (int j = 0; j < listBox1.Items.Count; j++)
